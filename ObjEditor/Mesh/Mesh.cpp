...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  _MESH_FOR_GAME_ENGINE
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifdef _MESH_FOR_GAME_ENGINE

std::vector<DeferredMeshModel*> Mesh::convertToDeferred( ID3D10Device* aDev, D3DXVECTOR3 aCamPos  , ColourMapping* aColours )
{
  std::vector<DeferredMeshModel*> models;
  for (int i = 0; i < nComponents() ; ++i )
    models.push_back( mMeshObject[i]->convertToDeferred(aDev, aCamPos, aColours) );
  return models;
}
...
{
  return mMeshObject[0]->boundingSphere();
}

#endif
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  end _MESH_FOR_GAME_ENGINE
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////