...
#endif
#ifndef _MESH_QT_IO  
  //#include "RenderModel/Compounded/pointlistmodel.h"
#endif
...
public:
  ...
  friend class MeshCol;

  Intersections::BoundingSphere Mesh::boundingSphere() const;
  std::vector<DeferredMeshModel*> convertToDeferred( ID3D10Device* aDev, D3DXVECTOR3 aCamPos  , ColourMapping* aColours );
  std::vector<EditableMeshModel*> convert( ID3D10Device* aDev, D3DXVECTOR3 aCamPos  , ColourMapping* aColours );
#endif
