      ...
      if ( frontFacing )
      {
              ...
              j < faces[faceIndex].nEdges() ; ++j )
        {
               ...
               !knifeEdgeNotInBorders( aInfo, edgeId ) )
          {
            ...
            bool intersect = Intersections2d::segmentIntersectionExclusive( knifeSegB,
                                                                          knifeSegE,
                                                                          edgeB,
                                                                          edgeE );
            if ( intersect )
            {
              ...
              D3DXVECTOR2 point2d = Intersections2d::pointOfIntersectingSegments(knifeSegB, knifeSegE, edgeB, edgeE );
